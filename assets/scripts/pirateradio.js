...
$(window).ready(function() {
  ...
  function persistent_connect() {
    ...
    socket.on('message', function(data) {
      ...
      switch(message.type) {
        case 'message':
          var avatar = (nearby[message.from] && nearby[message.from].avatar) ? nearby[message.from].avatar : '/pr_anon-avatar_40x40.png';
        ...
        case 'subscribe':
          ...
          var avatar = (nearby[message.id] && nearby[message.id].avatar) ? nearby[message.id].avatar : '/pr_anon-avatar_40x40.png';
